...
# from racc grammer file "calendar_parser82.y".
#
...
module_eval <<'.,.,', 'calendar_parser82.y', 16
...
module_eval <<'.,.,', 'calendar_parser82.y', 17
...
module_eval <<'.,.,', 'calendar_parser82.y', 21
...
module_eval <<'.,.,', 'calendar_parser82.y', 24
...
module_eval <<'.,.,', 'calendar_parser82.y', 26
